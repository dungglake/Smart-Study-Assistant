...
<template>
  <div class="w-full h-full relative rounded-3xl bg-white overflow-hidden flex flex-col items-start p-6 box-border gap-6 text-left text-lg text-gray-200 font-inter">
    ...
    <div class="self-stretch flex-1 flex flex-col items-start gap-2 min-w-[96px] text-base text-darkslategray">
      <div
        class="self-stretch flex-1 rounded-lg border border-dashed border-[#c7d2fe] overflow-hidden flex flex-col items-center justify-center p-4 min-h-[320px] cursor-pointer"
        @click="openFilePicker"
        @dragover.prevent
        @drop.prevent="onDrop"
      >
        <div class="w-full flex flex-col items-center py-3 px-4 box-border gap-3 max-w-full">
          ...
          <div class="self-stretch flex items-center justify-center pt-1 text-center text-[#6b7280]">
